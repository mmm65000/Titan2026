...
Public Class rptCreditTerms
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sales_and_Inventory_System.rptCreditTerms.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCreditTerms
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCreditTerms = New rptCreditTerms()
        rpt.Site = Me.Site
        Return rpt
    End Function
