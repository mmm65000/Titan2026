...
Public Class SubRPTexpenses
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sales_and_Inventory_System.SubRPTexpenses.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSubRPTexpenses
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SubRPTexpenses = New SubRPTexpenses()
        rpt.Site = Me.Site
        Return rpt
    End Function
