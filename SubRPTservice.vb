...
Public Class SubRPTservice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sales_and_Inventory_System.SubRPTservice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSubRPTservice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SubRPTservice = New SubRPTservice()
        rpt.Site = Me.Site
        Return rpt
    End Function
