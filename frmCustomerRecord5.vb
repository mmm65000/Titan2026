...
Public Class frmCustomerRecord5
    ...
    Private Sub dgw_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles dgw.MouseDoubleClick
        Try
            If dgw.Rows.Count > 0 Then
                ...
                frmCustomerLedger.txtCustomerID.Text = dr.Cells(1).Value.ToString()
                frmCustomerLedger.cmbCustomerName.Text = dr.Cells(2).Value.ToString()
