...
Public Class frmSalesmanRecord_3
    ...
    Private Sub dgw_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs) Handles dgw.MouseDoubleClick
        Try
            If dgw.Rows.Count > 0 Then
                ...
                frmPayment_3.Show()
                Me.Hide()
                frmPayment_3.txtSM_ID.Text = dr.Cells(0).Value.ToString()
                frmPayment_3.txtSalesmanID.Text = dr.Cells(1).Value.ToString()
                frmPayment_3.txtSalesman.Text = dr.Cells(2).Value.ToString()
                frmPayment_3.txtCommissionPer.Text = dr.Cells(9).Value.ToString()
                lblSet.Text = ""
                'End If
            End If
        Catch ex As Exception
    ...
    End Sub
    Private Sub frmSalesmanRecord_3_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Getdata()
    End Sub
