...
Public Class frmSMS
    ...
    Private Sub btnDeleteAllLogs_Click_1(sender As Object, e As EventArgs) Handles btnDeleteAllLogs.Click
        Try
            If MessageBox.Show("هل أنت متأكد أنك تريد حذف جميع الرائل?", "تأكيد", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) = Windows.Forms.DialogResult.Yes Then
                DeleteRecord()
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
