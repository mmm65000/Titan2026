...
Public Class rptSalesTaxReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sales_and_Inventory_System.rptSalesTaxReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSalesTaxReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSalesTaxReport = New rptSalesTaxReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
