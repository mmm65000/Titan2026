...
Public Class frmCategory
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If txtcategory.Text = "" Then
            MessageBox.Show("الرجاء كتابة اسم الفئة", "", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            txtCategory.Focus()
            Return
        End If
        ...
        Try
            ...
            If rdr.Read() Then
                MessageBox.Show("الفئة المدخلة موجودة مسبقا", "خطأ", MessageBoxButtons.OK, MessageBoxIcon.[Error])
                txtCategory.Text = ""
                txtcategory.Focus()
    ...
    Private Sub DeleteRecord()
        ...
        Try
            ...
            rdr = cmd.ExecuteReader()
            If rdr.Read Then
                MessageBox.Show("لا يمكن الحذف .. قيد الاستخدام بالفعل في إدخال الفئة الفرعية", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
