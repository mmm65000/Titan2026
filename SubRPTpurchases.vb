...
Public Class SubRPTpurchases
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sales_and_Inventory_System.SubRPTpurchases.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSubRPTpurchases
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SubRPTpurchases = New SubRPTpurchases()
        rpt.Site = Me.Site
        Return rpt
    End Function
