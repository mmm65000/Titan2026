...
Public Class frmCustomerRecord1
    ...
    Public Sub Getdata()
        Try
            ...
            'con = New SqlConnection(cs)
            'con.Open()
            'cmd = New SqlCommand("SELECT RTRIM(ID),RTRIM(Credit) from LedgerBook ", con)

            'rdr = cmd.ExecuteReader(CommandBehavior.CloseConnection)
            'While (rdr.Read() = True)
            '    dgw.Rows.Add(rdr(0), rdr(10))
    ...
    Private Sub dgw_RowPostPaint(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewRowPostPaintEventArgs) Handles dgw.RowPostPaint
        ...
        If dgw.RowHeadersWidth < Convert.ToInt32((size.Width + 50)) Then
            dgw.RowHeadersWidth = Convert.ToInt32((size.Width + 50))
        End If
